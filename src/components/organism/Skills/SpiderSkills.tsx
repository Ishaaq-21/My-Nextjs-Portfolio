...
// 1. Define Props for IconWrapper
...
const IconWrapper: React.FC<IconWrapperProps> = ({
  ...
  <div
    className={`icon-wrapper cursor-target text-title dark:text-white
...
// 2. Define the shape of an Icon object
interface IconType {
  id: number;
...
const IconGrid: React.FC = () => {
  // 3. Type the state for hoveredId
  const [hoveredId, setHoveredId] = useState<number | null>(null);

  // 4. Type the array of icon objects
  const outerIcons: IconType[] = [
    ...
    { id: 7, component: <NextjsIcon /> },
    { id: 8, component: <MssqlIcon /> },
    { id: 9, component: <N8nIcon /> },
    ...
    <div className="icon-grid w-[400px] h-[400px] md:w-[500px] md:h-[500px] scale-75 md:scale-90 lg:scale-110 ">
      ...
      >
        <g>
          ...
          {/* Spoke Lines (connecting center to outer icons) */}
          {outerIcons.map((icon, i) => {
