import TextType from "@/components/AnimatedUiBlocks/TextType";
  ...
  return (
    <div className="main-content order-2 md:order-1 lg:grow-[1] self-start md:self-auto ">
      <div className="flex items-center gap-3  md:gap-24 lg:gap-12 mb-2 lg:mb-5 ">
        ...
        <div className="hand-container relative  inline-block w-8 md:w-10 lg:w-12">
          <Image
            src="/hand.svg"
      ...
      <Link className="main-btn text-base cursor-target" href="#Contact">
        Say Hello
        <i
