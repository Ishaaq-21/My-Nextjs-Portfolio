...
import DarkModeToggle from "../../atoms/DarkModeButton/DarkModeButton";
...
export default function Header() {
  ...
  return (
    <header className="shadow-top  left-0 bottom-0 md:top-0 z-50 bg-secondary-bg dark:bg-slate-900 dark:md:bg-slate-900/90 fixed w-full  h-[45px] md:h-[70px] md:shadow-[0px_-1px_5px_0px_black] dark:md:shadow-[0px_-1px_5px_0px_white]">
